...
goog.addDependency("../wizard_lord/data/enemies/troll.js", ['wizard_lord.data.enemies.troll'], ['cljs.core', 'wizard_lord.data.enemies.enemy']);
...
goog.addDependency("../wizard_lord/services/state/enemy.js", ['wizard_lord.services.state.enemy'], ['cljs.core']);
goog.addDependency("../wizard_lord/services/state/locations.js", ['wizard_lord.services.state.locations'], ['cljs.core']);
...
goog.addDependency("../wizard_lord/services/state/dispatcher.js", ['wizard_lord.services.state.dispatcher'], ['wizard_lord.services.state.locations', 'wizard_lord.services.state.combat', 'cljs.core', 'wizard_lord.services.state.global', 'wizard_lord.services.state.enemy', 'wizard_lord.services.state.textstate', 'wizard_lord.services.state.movement']);
...
goog.addDependency("../wizard_lord/services/scripts/movement.js", ['wizard_lord.services.scripts.movement'], ['cljs.core']);
...
goog.addDependency("../wizard_lord/views/combat.js", ['wizard_lord.views.combat'], ['wizard_lord.services.state.dispatcher', 'cljs.core', 'wizard_lord.data.battlemats.generic', 'wizard_lord.data.enemies.enemy', 'wizard_lord.services.scripts.helpers', 'wizard_lord.services.scripts.attacks', 'wizard_lord.components.combat.player', 'wizard_lord.components.combat.enemy', 'wizard_lord.services.scripts.movement', 'wizard_lord.services.state.initiative', 'wizard_lord.data.enemies.orc', 'wizard_lord.services.scripts.range']);
...
goog.addDependency("../wizard_lord/data/locations/character.js", ['wizard_lord.data.locations.character'], ['cljs.core']);
goog.addDependency("../wizard_lord/data/locations/town.js", ['wizard_lord.data.locations.town'], ['cljs.core']);
goog.addDependency("../wizard_lord/data/locations/locations.js", ['wizard_lord.data.locations.locations'], ['wizard_lord.data.locations.town', 'cljs.core']);
...
goog.addDependency("../wizard_lord/views/main.js", ['wizard_lord.views.main'], ['wizard_lord.data.locations.locations', 'wizard_lord.services.state.dispatcher', 'cljs.core', 'wizard_lord.components.options', 'wizard_lord.components.frame']);
