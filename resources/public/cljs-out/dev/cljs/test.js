...
var G__10084 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10084,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10084;
}
});
...
var len__4730__auto___10089 = arguments.length;
var i__4731__auto___10090 = (0);
while(true){
if((i__4731__auto___10090 < len__4730__auto___10089)){
args__4736__auto__.push((arguments[i__4731__auto___10090]));

var G__10091 = (i__4731__auto___10090 + (1));
i__4731__auto___10090 = G__10091;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10086){
var G__10087 = cljs.core.first.call(null,seq10086);
var seq10086__$1 = cljs.core.next.call(null,seq10086);
var G__10088 = cljs.core.first.call(null,seq10086__$1);
var seq10086__$2 = cljs.core.next.call(null,seq10086__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10087,G__10088,seq10086__$2);
});
...
var file = cljs.core.get.call(null,map__10093__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10093__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10093__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10093,map__10093__$1,file,line,column){
return (function (p1__10092_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10092_SHARP_));
});})(map__10093,map__10093__$1,file,line,column))
...
var temp__5457__auto___10095 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10095)){
var message_10096 = temp__5457__auto___10095;
cljs.core.println.call(null,message_10096);
} else {
}
...
var temp__5457__auto___10097 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10097)){
var message_10098 = temp__5457__auto___10097;
cljs.core.println.call(null,message_10098);
} else {
}
...
var output_dir__$1 = (function (){var G__10099 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10099,"/"].join('');
} else {
return G__10099;
}
})();
...
var G__10101 = exception.stack;
var G__10101__$1 = (((G__10101 == null))?null:clojure.string.split_lines.call(null,G__10101));
var G__10101__$2 = (((G__10101__$1 == null))?null:cljs.core.get.call(null,G__10101__$1,depth));
if((G__10101__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10101__$2);
}
} else {
...
var vec__10102 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10102,(0),null);
var column = cljs.core.nth.call(null,vec__10102,(1),null);
var vec__10105 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10105,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10105,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10105,(2),null);
...
var m__$1 = (function (){var G__10108 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10112 = (function (){var G__10111 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10111);
} else {
return G__10111;
}
})();
...
return cljs.core.vary_meta.call(null,G__10113,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__10115 = e;
var G__10115__$1 = (((G__10115 instanceof cljs.core.Keyword))?G__10115.fqn:null);
switch (G__10115__$1) {
...
var vec__10117 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10117,(0),null);
var types = vec__10117;
...
return cljs.core.map.call(null,(function (p__10120){
var vec__10121 = p__10120;
var ns = cljs.core.nth.call(null,vec__10121,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10121,(1),null);
return ((function (vec__10121,ns,vars__$1){
return (function (){
...
var G__10124 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__10124__$1 = (((G__10124 instanceof cljs.core.Keyword))?G__10124.fqn:null);
switch (G__10124__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10124,G__10124__$1,env,once_fixtures,each_fixtures,vec__10121,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10124,G__10124__$1,env,once_fixtures,each_fixtures,vec__10121,ns,vars__$1){
return (function (){
var seq__10125 = cljs.core.seq.call(null,vars__$1);
var chunk__10126 = null;
var count__10127 = (0);
var i__10128 = (0);
while(true){
if((i__10128 < count__10127)){
var v = cljs.core._nth.call(null,chunk__10126,i__10128);
var temp__5457__auto___10130 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10130)){
var t_10131 = temp__5457__auto___10130;
each_fixture_fn.call(null,((function (seq__10125,chunk__10126,count__10127,i__10128,t_10131,temp__5457__auto___10130,v,each_fixture_fn,G__10124,G__10124__$1,env,once_fixtures,each_fixtures,vec__10121,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10131)));
});})(seq__10125,chunk__10126,count__10127,i__10128,t_10131,temp__5457__auto___10130,v,each_fixture_fn,G__10124,G__10124__$1,env,once_fixtures,each_fixtures,vec__10121,ns,vars__$1))
);
} else {
}


var G__10132 = seq__10125;
var G__10133 = chunk__10126;
var G__10134 = count__10127;
var G__10135 = (i__10128 + (1));
seq__10125 = G__10132;
chunk__10126 = G__10133;
count__10127 = G__10134;
i__10128 = G__10135;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__10125);
if(temp__5457__auto__){
var seq__10125__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10125__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__10125__$1);
var G__10136 = cljs.core.chunk_rest.call(null,seq__10125__$1);
var G__10137 = c__4550__auto__;
var G__10138 = cljs.core.count.call(null,c__4550__auto__);
var G__10139 = (0);
seq__10125 = G__10136;
chunk__10126 = G__10137;
count__10127 = G__10138;
i__10128 = G__10139;
continue;
} else {
var v = cljs.core.first.call(null,seq__10125__$1);
var temp__5457__auto___10140__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10140__$1)){
var t_10141 = temp__5457__auto___10140__$1;
each_fixture_fn.call(null,((function (seq__10125,chunk__10126,count__10127,i__10128,t_10141,temp__5457__auto___10140__$1,v,seq__10125__$1,temp__5457__auto__,each_fixture_fn,G__10124,G__10124__$1,env,once_fixtures,each_fixtures,vec__10121,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10141)));
});})(seq__10125,chunk__10126,count__10127,i__10128,t_10141,temp__5457__auto___10140__$1,v,seq__10125__$1,temp__5457__auto__,each_fixture_fn,G__10124,G__10124__$1,env,once_fixtures,each_fixtures,vec__10121,ns,vars__$1))
);
} else {
}


var G__10142 = cljs.core.next.call(null,seq__10125__$1);
var G__10143 = null;
var G__10144 = (0);
var G__10145 = (0);
seq__10125 = G__10142;
chunk__10126 = G__10143;
count__10127 = G__10144;
i__10128 = G__10145;
continue;
}
} else {
...
});})(each_fixture_fn,G__10124,G__10124__$1,env,once_fixtures,each_fixtures,vec__10121,ns,vars__$1))
);
});})(each_fixture_fn,G__10124,G__10124__$1,env,once_fixtures,each_fixtures,vec__10121,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10124__$1)].join('')));

}
})());
});
;})(vec__10121,ns,vars__$1))
