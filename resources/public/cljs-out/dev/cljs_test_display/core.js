...
var len__4730__auto___10167 = arguments.length;
var i__4731__auto___10168 = (0);
while(true){
if((i__4731__auto___10168 < len__4730__auto___10167)){
args__4736__auto__.push((arguments[i__4731__auto___10168]));

var G__10169 = (i__4731__auto___10168 + (1));
i__4731__auto___10168 = G__10169;
continue;
} else {
}
break;
...
return cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4737__auto__);
});
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq10164){
var G__10165 = cljs.core.first.call(null,seq10164);
var seq10164__$1 = cljs.core.next.call(null,seq10164);
var G__10166 = cljs.core.first.call(null,seq10164__$1);
var seq10164__$2 = cljs.core.next.call(null,seq10164__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10165,G__10166,seq10164__$2);
});
...
var vec__10170 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__10170,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__10170,(1),null);
var G__10173 = cljs.core.PersistentArrayMap.EMPTY;
var G__10173__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__10173,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10173);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__10173__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__10173__$1;
}
} else {
...
return (function() { 
var G__10177__delegate = function (klass,contents){
var vec__10174 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__10174,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__10174,(1),null);
...
var G__10177 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__10178__i = 0, G__10178__a = new Array(arguments.length -  1);
while (G__10178__i < G__10178__a.length) {G__10178__a[G__10178__i] = arguments[G__10178__i + 1]; ++G__10178__i;}
  contents = new cljs.core.IndexedSeq(G__10178__a,0,null);
} 
return G__10177__delegate.call(this,klass,contents);};
G__10177.cljs$lang$maxFixedArity = 1;
G__10177.cljs$lang$applyTo = (function (arglist__10179){
var klass = cljs.core.first(arglist__10179);
var contents = cljs.core.rest(arglist__10179);
return G__10177__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__10183){
var map__10184 = p__10183;
var map__10184__$1 = (((((!((map__10184 == null))))?(((((map__10184.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10184.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10184):map__10184);
var ns = cljs.core.get.call(null,map__10184__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__10184__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__10186){
...
var actual = cljs.core.get.call(null,map__10187__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__10187__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__10189){
var map__10190 = p__10189;
...
var expected = cljs.core.get.call(null,map__10190__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__10190__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__10192_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__10194 = cljs_test_display.core.current_var_info.call(null);
var map__10194__$1 = (((((!((map__10194 == null))))?(((((map__10194.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10194.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10194):map__10194);
var info = map__10194__$1;
var name = cljs.core.get.call(null,map__10194__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__10194__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__10194__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__10194,map__10194__$1,info,name,line,file,node){
return (function (p1__10193_SHARP_){
return cljs.core.cons.call(null,node,p1__10193_SHARP_);
});})(curr_node,map__10194,map__10194__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__10196){
var map__10197 = p__10196;
var map__10197__$1 = (((((!((map__10197 == null))))?(((((map__10197.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10197.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10197):map__10197);
var m = map__10197__$1;
var fail = cljs.core.get.call(null,map__10197__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__10197__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__10197__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__10197__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___10199 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10199)){
var message_10200 = temp__5457__auto___10199;
cljs.core.println.call(null,message_10200);
} else {
}
...
var temp__5457__auto___10201 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10201)){
var message_10202 = temp__5457__auto___10201;
cljs.core.println.call(null,message_10202);
} else {
}
