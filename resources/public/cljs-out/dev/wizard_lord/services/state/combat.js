...
wizard_lord.services.state.combat.update_character_movement = (function wizard_lord$services$state$combat$update_character_movement(players,payload){
return cljs.core.map.call(null,(function (character){
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(character),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(payload))){
...
wizard_lord.services.state.combat.handle_character_move_reduce_value = (function wizard_lord$services$state$combat$handle_character_move_reduce_value(app_state,payload){
return cljs.core.swap_BANG_.call(null,app_state,cljs.core.update_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"combat-view","combat-view",585821215),new cljs.core.Keyword(null,"players","players",-1361554569)], null),wizard_lord.services.state.combat.update_character_movement,payload);
});
wizard_lord.services.state.combat.handle_character_move_check_remaining = (function wizard_lord$services$state$combat$handle_character_move_check_remaining(app_state,payload){
var character = cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__14373_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__14373_SHARP_),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(payload));
...
return wizard_lord.services.state.combat.update_move_active.call(null,app_state,false);
} else {
return null;
}
});
...
cljs.core.swap_BANG_.call(null,app_state,cljs.core.update_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"combat-view","combat-view",585821215),new cljs.core.Keyword(null,"players","players",-1361554569)], null),wizard_lord.services.state.combat.update_character_positions,payload);

wizard_lord.services.state.combat.handle_character_move_reduce_value.call(null,app_state,payload);

return wizard_lord.services.state.combat.handle_character_move_check_remaining.call(null,app_state,payload);
});
