...
var character = cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__15601_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__15601_SHARP_),new cljs.core.Keyword(null,"current-initiative","current-initiative",62014760).cljs$core$IFn$_invoke$arity$1(combat_state));
...
var character = cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__15602_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__15602_SHARP_),new cljs.core.Keyword(null,"current-initiative","current-initiative",62014760).cljs$core$IFn$_invoke$arity$1(combat_state));
}),new cljs.core.Keyword(null,"players","players",-1361554569).cljs$core$IFn$_invoke$arity$1(combat_state)));
var x = e.dataset.x;
var y = e.dataset.y;
var moveDistance = ((5) * (Math.abs((new cljs.core.Keyword(null,"x","x",2099068185).cljs$core$IFn$_invoke$arity$1(character) - x)) + Math.abs((new cljs.core.Keyword(null,"y","y",-1757859776).cljs$core$IFn$_invoke$arity$1(character) - y))));
...
var G__15605 = ((1) + innerIndex);
var G__15606 = cljs.core.conj.call(null,innerRow,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.Battlemat__column","div.Battlemat__column",-1566715691),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"data-x","data-x",369429472),innerIndex,new cljs.core.Keyword(null,"data-y","data-y",1384135050),index,new cljs.core.Keyword(null,"key","key",-1516042587),innerIndex,new cljs.core.Keyword(null,"class","class",-2030961996),(((!(wizard_lord.views.combat.get_moveable_grid.call(null,innerIndex,index,combat_state))))?"Battlemat__column--oor":null)], null)], null));
innerIndex = G__15605;
innerRow = G__15606;
continue;
}
...
var character = cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__15607_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__15607_SHARP_),new cljs.core.Keyword(null,"current-initiative","current-initiative",62014760).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"combat-view","combat-view",585821215).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,app_state))));
...
return wizard_lord.views.combat.handle_grid_click.call(null,p1__15608_SHARP_.target,new cljs.core.Keyword(null,"combat-view","combat-view",585821215).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,app_state)));
});})(character))
], null),(function (){var iter__4523__auto__ = ((function (character){
return (function wizard_lord$views$combat$Combat_$_iter__15609(s__15610){
return (new cljs.core.LazySeq(null,((function (character){
return (function (){
var s__15610__$1 = s__15610;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__15610__$1);
if(temp__5457__auto__){
var s__15610__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__15610__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__15610__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__15612 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__15611 = (0);
while(true){
if((i__15611 < size__4522__auto__)){
var row = cljs.core._nth.call(null,c__4521__auto__,i__15611);
cljs.core.chunk_append.call(null,b__15612,row);
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__15612),wizard_lord$views$combat$Combat_$_iter__15609.call(null,cljs.core.chunk_rest.call(null,s__15610__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__15612),null);
}
} else {
var row = cljs.core.first.call(null,s__15610__$2);
return cljs.core.cons.call(null,row,wizard_lord$views$combat$Combat_$_iter__15609.call(null,cljs.core.rest.call(null,s__15610__$2)));
}
} else {
return null;
}
...
return (function wizard_lord$views$combat$Combat_$_iter__15613(s__15614){
return (new cljs.core.LazySeq(null,((function (character){
return (function (){
var s__15614__$1 = s__15614;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__15614__$1);
if(temp__5457__auto__){
var s__15614__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__15614__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__15614__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__15616 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__15615 = (0);
while(true){
if((i__15615 < size__4522__auto__)){
var player = cljs.core._nth.call(null,c__4521__auto__,i__15615);
cljs.core.chunk_append.call(null,b__15616,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [wizard_lord.components.combat.player.Player,player,new cljs.core.Keyword(null,"combat-view","combat-view",585821215).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,app_state))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(player)], null)));

var G__15622 = (i__15615 + (1));
i__15615 = G__15622;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__15616),wizard_lord$views$combat$Combat_$_iter__15613.call(null,cljs.core.chunk_rest.call(null,s__15614__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__15616),null);
}
} else {
var player = cljs.core.first.call(null,s__15614__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [wizard_lord.components.combat.player.Player,player,new cljs.core.Keyword(null,"combat-view","combat-view",585821215).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,app_state))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(player)], null)),wizard_lord$views$combat$Combat_$_iter__15613.call(null,cljs.core.rest.call(null,s__15614__$2)));
}
} else {
return null;
}
...
return (function wizard_lord$views$combat$Combat_$_iter__15617(s__15618){
return (new cljs.core.LazySeq(null,((function (character){
return (function (){
var s__15618__$1 = s__15618;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__15618__$1);
if(temp__5457__auto__){
var s__15618__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__15618__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__15618__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__15620 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__15619 = (0);
while(true){
if((i__15619 < size__4522__auto__)){
var enemy = cljs.core._nth.call(null,c__4521__auto__,i__15619);
cljs.core.chunk_append.call(null,b__15620,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [wizard_lord.components.combat.enemy.Enemy,enemy,new cljs.core.Keyword(null,"combat-view","combat-view",585821215).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,app_state))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(enemy)], null)));

var G__15623 = (i__15619 + (1));
i__15619 = G__15623;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__15620),wizard_lord$views$combat$Combat_$_iter__15617.call(null,cljs.core.chunk_rest.call(null,s__15618__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__15620),null);
}
} else {
var enemy = cljs.core.first.call(null,s__15618__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [wizard_lord.components.combat.enemy.Enemy,enemy,new cljs.core.Keyword(null,"combat-view","combat-view",585821215).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,app_state))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(enemy)], null)),wizard_lord$views$combat$Combat_$_iter__15617.call(null,cljs.core.rest.call(null,s__15618__$2)));
}
} else {
return null;
}
...
], null),"Attack"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (character){
return (function (){
