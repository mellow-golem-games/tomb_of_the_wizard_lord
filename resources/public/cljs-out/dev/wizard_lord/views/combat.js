...
var character = cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__14404_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__14404_SHARP_),new cljs.core.Keyword(null,"current-initiative","current-initiative",62014760).cljs$core$IFn$_invoke$arity$1(combat_state));
...
if(cljs.core.truth_(new cljs.core.Keyword(null,"move-active","move-active",-410074174).cljs$core$IFn$_invoke$arity$1(combat_state))){
var character = cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__14405_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__14405_SHARP_),new cljs.core.Keyword(null,"current-initiative","current-initiative",62014760).cljs$core$IFn$_invoke$arity$1(combat_state));
}),new cljs.core.Keyword(null,"players","players",-1361554569).cljs$core$IFn$_invoke$arity$1(combat_state)));
var x = e.dataset.x;
var y = e.dataset.y;
var moveDistance = ((5) * (Math.abs((new cljs.core.Keyword(null,"x","x",2099068185).cljs$core$IFn$_invoke$arity$1(character) - x)) + Math.abs((new cljs.core.Keyword(null,"y","y",-1757859776).cljs$core$IFn$_invoke$arity$1(character) - y))));
...
var G__14408 = ((1) + innerIndex);
var G__14409 = cljs.core.conj.call(null,innerRow,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.Battlemat__column","div.Battlemat__column",-1566715691),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"data-x","data-x",369429472),innerIndex,new cljs.core.Keyword(null,"data-y","data-y",1384135050),index,new cljs.core.Keyword(null,"key","key",-1516042587),innerIndex,new cljs.core.Keyword(null,"class","class",-2030961996),(((!(wizard_lord.views.combat.get_moveable_grid.call(null,innerIndex,index,combat_state))))?"Battlemat__column--oor":null)], null)], null));
innerIndex = G__14408;
innerRow = G__14409;
continue;
}
...
var character = cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__14410_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__14410_SHARP_),new cljs.core.Keyword(null,"current-initiative","current-initiative",62014760).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"combat-view","combat-view",585821215).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,app_state))));
...
return (function (p1__14411_SHARP_){
return wizard_lord.views.combat.handle_grid_click.call(null,p1__14411_SHARP_.target,new cljs.core.Keyword(null,"combat-view","combat-view",585821215).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,app_state)));
});})(character))
], null),(function (){var iter__4523__auto__ = ((function (character){
return (function wizard_lord$views$combat$Combat_$_iter__14412(s__14413){
return (new cljs.core.LazySeq(null,((function (character){
return (function (){
var s__14413__$1 = s__14413;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__14413__$1);
if(temp__5457__auto__){
var s__14413__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__14413__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__14413__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__14415 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__14414 = (0);
while(true){
if((i__14414 < size__4522__auto__)){
var row = cljs.core._nth.call(null,c__4521__auto__,i__14414);
cljs.core.chunk_append.call(null,b__14415,row);

var G__14420 = (i__14414 + (1));
i__14414 = G__14420;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__14415),wizard_lord$views$combat$Combat_$_iter__14412.call(null,cljs.core.chunk_rest.call(null,s__14413__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__14415),null);
}
} else {
var row = cljs.core.first.call(null,s__14413__$2);
return cljs.core.cons.call(null,row,wizard_lord$views$combat$Combat_$_iter__14412.call(null,cljs.core.rest.call(null,s__14413__$2)));
}
} else {
return null;
}
...
return (function wizard_lord$views$combat$Combat_$_iter__14416(s__14417){
return (new cljs.core.LazySeq(null,((function (character){
return (function (){
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__14419),wizard_lord$views$combat$Combat_$_iter__14416.call(null,cljs.core.chunk_rest.call(null,s__14417__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__14419),null);
}
} else {
var player = cljs.core.first.call(null,s__14417__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [wizard_lord.components.combat.player.Player,player,new cljs.core.Keyword(null,"combat-view","combat-view",585821215).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,app_state))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(player)], null)),wizard_lord$views$combat$Combat_$_iter__14416.call(null,cljs.core.rest.call(null,s__14417__$2)));
}
} else {
return null;
}
