...
var G__12035 = devtools.prefs.pref.call(null,v);
v = G__12035;
continue;
} else {
return v;
...
}catch (e12038){var _e__11047__auto__ = e12038;
return false;
}})();
...
}catch (e12042){var _e__11047__auto__ = e12042;
return false;
}})();
...
}catch (e12044){var _e__11047__auto__ = e12044;
return false;
}}
}
});
...
var vec__12046 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12046,(0),null);
var name = cljs.core.nth.call(null,vec__12046,(1),null);
...
return cljs.core.some.call(null,(function (p1__12049_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12049_SHARP_);
}),template);
});
